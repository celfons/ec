...
import br.com.vr.domains.events.IncreasedPurchaseCardEvent;
...
public class PurchaseCard extends AggregateRoot {
    ...
    protected void apply(Event event) {
        ...
        else if(event instanceof IncreasedPurchaseCardEvent){
            events.add(gson.toJson(event));
        }
    }
    ...
    public void increasePurchaseCard(IncreasedPurchaseCardEvent increasedPurchaseCardEvent){
        apply(increasedPurchaseCardEvent);
    }

    public void increasePurchaseCard(IncreasePurchaseCardCommand increasePurchaseCardCommand){
        this.transactions.add(
                Transaction
                        ...
                        .value(increasePurchaseCardCommand.getValue())
                        .build()
        );
        this.balance += increasePurchaseCardCommand.getValue();
        increasePurchaseCard(
                IncreasedPurchaseCardEvent
                        .builder()
                        .purchaseCardId(this.getPurchaseCardId())
                        .value(increasePurchaseCardCommand.getValue())
                        .cnpj(this.cnpj)
                        .dateTransaction(new DateTime())
                        .transactionType("+")
